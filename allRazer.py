...
#  User input
    ...
    joinerWords = ['IN', 'ON','FOR','OF','THE','AT','TO','INTO','AS','FROM','OVER']
    joinerFactors = ['10', '4','4','9','4','2','9','1','2','1','2']
    joinerFactor, j = 0, -1
...
#  Step through each joiner word
    for joinChoice in joinerWords:
        j = j + 1
        print 'Join word is "{}"' .format(joinChoice)
        joinerFactor = int(joinerFactors[j])    # find the joiner word's frequency
        numChoice = joinerFactor * 5            # repeat factor times 5
